...
const getAvailableSlots = async (req, res) => {
    try {
        ...
        const result = await slotAvailabilityService.getAvailableSlots(id, date, {
            userId: userId || undefined,
            resourceId: resourceId || undefined,
            bufferMinutes: req.query.bufferMinutes ? Number(req.query.bufferMinutes) : undefined,
        ...
        res.json({
            success: true,
            data: {
                date: result.metadata?.date || date,
                dayOfWeek: result.metadata?.dayOfWeek,
                timezone: result.metadata?.timezone,
                slots: result.availableSlots,
                waitlistedSlots: result.waitlistedSlots,
